...
#                       constants.nhl_team_names.TORONTO_MAPLE_LEAFS,
#                       "150")
# toolkit.set_user_balance("0bd6be7e-7d5d-4c60-a0e4-9f50f93b04c9", "10000")
# buy_shares.buy_shares("1", constants.nhl_team_names.MONTREAL_CANADIENS, "100")
...
print(price_management.refresh_prices())
